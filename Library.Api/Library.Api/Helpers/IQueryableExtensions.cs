...
namespace Library.Api.Helpers
{
    public static class IQueryableExtensions
    {
            ...
            Dictionary<string,PropertyMappingValue> mappingDictionary)
        {
            ...
            //the orderBy is separated by ",", so we split it.
            ...
            foreach (var orderByClause in orderByAfterSplit.Reverse())
            {
                ...
                var orderDescoding = trimmedOrderByClause.EndsWith(" desc");
                ...
                foreach (var destinationProperty in propertyMappingValue.DestinationProperties.Reverse())
                {
                    ...
                    if (propertyMappingValue.Revert)
                        orderDescoding = !orderDescoding;
                    source = source.OrderBy(destinationProperty + (orderDescoding ? " descending" : " ascending"));
                }
            }
            return source;
        }
